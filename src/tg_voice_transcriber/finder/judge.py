...
def _build_system_prompt() -> str:
    ...
    return (
        ...
        "a cheap one.\n"
        "- CAREFUL with UNITS: 'часа'/'часов'/'hours' means HOURS, not days. "
        "'24 часа бесплатно' = 1 day → REJECT (trial_days=1). '48 часов' = 2 "
        "days → REJECT. Never read an hours number as a days number.\n"
        "\n"
